...
import { NumberInputSetting } from './common/NumberInputSetting.js';
    ...
    <SettingsWrapper>
      ...
      {status.gpioAvailable ? (
        <SettingsExpander
          header={
            <>
              <NumberInputSetting {...button.gpioPin} update={updateField('gpioPin')} />
              <SubLabel fontSize="s">
                Please use the command &apos;cat /sys/kernel/debug/gpio &apos; to find and enter the
                GPIO address for your corresponding pin.
              </SubLabel>
            </>
          }
        >
